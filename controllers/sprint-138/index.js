...
const representativeHaveAccessCode = require('./official-capacity/representative-have-access-code');
const representativeEnterAccessCode = require('./official-capacity/representative-enter-access-code');
const representativeAccessCodeNone = require('./official-capacity/representative-access-code-none');
...
module.exports = {
  ...
  representativeHaveAccessCode,
  representativeEnterAccessCode,
  representativeAccessCodeNone,
  birthDate,
  birthDateIneligible,
  otherBenefits,
